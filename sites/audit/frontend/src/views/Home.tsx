...
export default function Home() {
  ...
  const testimonials = [
    { quote: t('引入唯客智审后，我们的合同审核周期从平均3天缩短到了2小时。AI 的风险提示非常精准，帮我们规避了几次重大的合规风险。', 'After adopting Avaca AI Audit, our contract review cycle was reduced from an average of 3 days to just 2 hours. The AI risk alerts are highly accurate, helping us avoid several major compliance risks.'), author: t('某上市科技集团', 'A Listed Tech Group'), role: t('法务总监 Head of Legal', 'Head of Legal'), icon: Building2 },
          ...
          >
            ...
            <p className="text-slate-400 max-w-md mt-4 md:mt-0 text-sm">
              {t(
                ...
                'Avaca AI Audit is more than a tool — it is the digital infrastructure for corporate legal, helping enterprises accumulate risk control rules and data assets.'
              )}
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-500">{t('听听行业领袖们如何使用唯客智审提升效能。', 'Hear how industry leaders use Avaca AI Audit to boost efficiency.')}</p>
          </motion.div>
          <motion.div
            variants={staggerContainer}
            initial="initial"
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">{t('为什么选择唯客智审？', 'Why Choose Avaca AI Audit?')}</h2>
