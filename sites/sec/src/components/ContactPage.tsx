        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 items-stretch max-w-7xl mx-auto">
            ...
            <div className="space-y-4 lg:space-y-5 flex-1">
              <div className="flex items-start gap-4 p-4 lg:p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div className="flex-1">
                  <p className="font-bold text-slate-900 text-sm lg:text-base mb-1">微信咨询</p>
                  <p className="text-slate-500 text-xs lg:text-sm mb-3">扫描二维码<br/>添加安全专家一对一沟通</p>
                  <img src="/wechat-qr.png" alt="微信二维码" className="w-32 h-32 object-contain rounded-lg border border-gray-100" />
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 lg:p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                <div className="w-10 h-10 lg:w-11 lg:h-11 bg-blue-50 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-sm lg:text-base mb-1">致电我们</p>
              ...
              <div className="flex items-start gap-4 p-4 lg:p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-sm lg:text-base mb-1">发送邮件</p>
          ...
          <div className="lg:w-7/12 w-full flex flex-col">
            <div className="bg-white rounded-3xl shadow-xl p-6 lg:p-10 border border-gray-100 flex flex-col flex-1">
              <h2 className="text-xl lg:text-2xl font-bold text-slate-900 mb-1 lg:mb-2">填写需求单</h2>
              <p className="text-slate-500 text-sm mb-6 lg:mb-8">收到您的信息后，我们将在 1 个工作日内与您取得联系。</p>
                  ...
                  <div className="flex gap-2 lg:gap-3">
                    ...
                    <div className="w-28 lg:w-32 h-10 lg:h-11 rounded-lg border border-slate-200 overflow-hidden flex items-center justify-center bg-slate-50">
                      {captchaLoading ? (
                        ...
                        <img src={captchaSvg} alt="验证码" className="w-full h-full object-contain" />
                      ) : (
                        <span className="text-xs text-slate-400">点击刷新</span>
                      )}
                    </div>
                    <button
                      type="button"
