      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/features" className="hover:text-brand-blue text-left">{t('产品功能', 'Features')}</a></li>
            <li><a href="/changelog" className="hover:text-brand-blue text-left">{t('更新日志', 'Changelog')}</a></li>
            <li><a href="/roadmap" className="hover:text-brand-blue text-left">{t('技术路线图', 'Roadmap')}</a></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/" className="hover:text-brand-blue text-white font-medium text-left">{t('AI 安全', 'AI Security')}</a></li>
          </ul>
        </div>
        <div>
          <h4 className="text-white font-bold mb-4 h-14 flex items-start pt-0">{t('关于我们', 'About Us')}</h4>
          <ul className="space-y-2">
            <li><a href="/about" className="hover:text-brand-blue">{t('关于 JOTO.AI', 'About JOTO.AI')}</a></li>
