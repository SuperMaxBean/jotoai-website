    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-sm">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><Link href="/features" className="hover:text-brand-blue">产品功能</Link></li>
          <li><Link href="/changelog" className="hover:text-brand-blue">更新日志</Link></li>
          <li><Link href="/roadmap" className="hover:text-brand-blue">技术路线图</Link></li>
        </ul>
      </div>
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><Link href="/" className="hover:text-brand-blue text-white font-medium">AI 安全</Link></li>
        </ul>
      </div>
      <div>
        <h4 className="text-white font-bold mb-4 h-14 flex items-start pt-0">关于我们</h4>
        <ul className="space-y-2">
          <li><Link href="/about" className="hover:text-brand-blue">关于 JOTO.AI</Link></li>
